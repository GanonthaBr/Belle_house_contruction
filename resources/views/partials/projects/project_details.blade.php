                ...
                <div class="card bg-light rounded">
                    <div class="card-body">
                        ...
                        <ul style="list-style-type: none; padding: 0;">
                            ...
                            {{-- <div class="d-flex left-content-between mb-3"><i class="fa fa-check text-primary pt-1"></i><span style="padding-left: 10px"><strong>Description :</strong> {{$project->description}}</span>
                    </div> --}}
