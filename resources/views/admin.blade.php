      ...
      <div class="page-inner">
        <div
          ...
          <div class="ms-md-auto py-2 py-md-0">
            ...
            <a href="www.bellehouseniger.com" class="btn btn-primary btn-round">Belle House</a>
          </div>
        </div>
        <div class="row">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="flag">
                                <img
                                  src="public/assets/img/flags/id.png"
                                  alt="indonesia" />
                              </div>
                            </td>
                            <td>Indonesia</td>
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img
                                  src="public/public/assets/img/flags/us.png"
                                  alt="united states" />
                              </div>
                            </td>
                            <td>USA</td>
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img
                                  src="public/assets/img/flags/au.png"
                                  alt="australia" />
                              </div>
                            </td>
                            <td>Australia</td>
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img
                                  src="public/assets/img/flags/ru.png"
                                  alt="russia" />
                              </div>
                            </td>
                            <td>Russia</td>
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img
                                  src="public/assets/img/flags/cn.png"
                                  alt="china" />
                              </div>
                            </td>
                            <td>China</td>
                          ...
                          <tr>
                            <td>
                              <div class="flag">
                                <img
                                  src="public/assets/img/flags/br.png"
                                  alt="brazil" />
                              </div>
                            </td>
                            <td>Brasil</td>
