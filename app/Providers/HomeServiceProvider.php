...
class HomeServiceProvider extends ServiceProvider
{
    ...
    {
        view()->composer(['partials.blog.blog_details', 'partials.about.index', 'partials.about.index', 'partials.testimonials', 'partials.admin.mainheader', 'partials.admin.project_list', 'partials.admin.realisation_list', 'partials.admin.service_list', 'partials.admin.partner_list', 'partials.admin.messages_list'], function ($view) {
            $view->with('blogs', \App\Models\Blog::all()->take(5))
                ...
                ->with('teams', \App\Models\Team::all())
                ->with('testimonials', \App\Models\Testimonial::all())
