...
class HomeServiceProvider extends ServiceProvider
{
    ...
    {
        view()->composer(['partials.blog.blog_details', 'partials.about.index', 'partials.testimonials', 'partials.admin.mainheader', 'partials.admin.project_list', 'partials.admin.realisation_list', 'partials.admin.service_list', 'partials.admin.partner_list', 'partials.admin.messages_list'], function ($view) {
